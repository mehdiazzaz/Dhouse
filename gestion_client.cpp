    ...
    ui(new Ui::gestion_client)
{
    ...
    QPixmap pix("C:/Users/HP/Desktop/Dhouse-module_gsetion_des_clients/client icon.jpg");
...
{
    player->setMedia(QUrl::fromLocalFile("C:/Users/HP/Desktop/Dhouse-module_gsetion_des_clients/Quitter.mp3"));
                player->play();
...
void gestion_client::on_pushButton_ajoute_clicked()
{
    ...
    int a=ui->lineEdit_age->text().toInt();
        ...
        if (test)
        {
            player->setMedia(QUrl::fromLocalFile("C:/Users/HP/Desktop/Dhouse-module_gsetion_des_clients/client ajouter.mp3"));
                        player->play();
                        qDebug()<<player->errorString();
                        QThread::sleep(1);
            ui->tableView->setModel(tempclient.afficher());
...
void gestion_client::on_pushButton_2_clicked()
{
    ...
    if (test)
    {
        player->setMedia(QUrl::fromLocalFile("C:/Users/HP/Desktop/Dhouse-module_gsetion_des_clients/client supprimer.mp3"));
                    player->play();
                    qDebug()<<player->errorString();
                    QThread::sleep(1);
        ui->tableView->setModel(tempclient.afficher());
...
void gestion_client::on_pushButton_modifer_clicked()
{
    ...
    int a=ui->lineEdit_age_modifer->text().toInt();
        ...
        if (test)
        {
            player->setMedia(QUrl::fromLocalFile("C:/Users/HP/Desktop/Dhouse-module_gsetion_des_clients/client modifier.mp3"));
                        player->play();
                        qDebug()<<player->errorString();
                        QThread::sleep(1);
            ui->tableView->setModel(tempclient.afficher());
...
{
    player->setMedia(QUrl::fromLocalFile("C:/Users/HP/Desktop/Dhouse-module_gsetion_des_clients/impression client.mp3"));
    player->play();
    qDebug()<<player->errorString();
    QThread::sleep(1);
    QPrinter printer;
...
{
    player->setMedia(QUrl::fromLocalFile("C:/Users/HP/Desktop/Dhouse-module_gsetion_des_clients/chercher client.mp3"));
                player->play();
                qDebug()<<player->errorString();
                QThread::sleep(1);
    ui->tableView->setModel(tempclient.afficher());
