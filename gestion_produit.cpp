    ...
    ui(new Ui::gestion_produit)
{
    ...
    QPixmap pix("C:/Users/HP/Desktop/Dhouse-module_gsetion_des_clients/icon promotion.jpg");
...
void gestion_produit::on_pushButton_4_clicked()
{
    ...
    QString pr=ui->lineEdit_promortion_porduit->text();
        ...
        if (test)
        {
            player->setMedia(QUrl::fromLocalFile("C:/Users/HP/Desktop/Dhouse-module_gsetion_des_clients/promotion ajouter.mp3"));
                        player->play();
                        qDebug()<<player->errorString();
                        QThread::sleep(1);
            ui->tableView->setModel(tempproduit.afficher());
...
void gestion_produit::on_pushButton_3_clicked()
{
    ...
    if (test)
    {
        player->setMedia(QUrl::fromLocalFile("C:/Users/HP/Desktop/Dhouse-module_gsetion_des_clients/promotion supprimer.mp3"));
                    player->play();
                    qDebug()<<player->errorString();
                    QThread::sleep(1);
        ui->tableView->setModel(tempproduit.afficher());
...
void gestion_produit::on_pushButton_2_clicked()
{
    ...
    QString pr=ui->lineEdit_promortion_porduit_modifer->text();
           crud_produit s(i,n,t,p,pr);
            ...
            if (test)
            {
                player->setMedia(QUrl::fromLocalFile("C:/Users/HP/Desktop/Dhouse-module_gsetion_des_clients/promotion modifier.mp3"));
                            player->play();
                            qDebug()<<player->errorString();
                            QThread::sleep(1);
                ui->tableView->setModel(tempproduit.afficher());
...
{
    player->setMedia(QUrl::fromLocalFile("C:/Users/HP/Desktop/Dhouse-module_gsetion_des_clients/impression promotion.mp3"));
    player->play();
    qDebug()<<player->errorString();
    QThread::sleep(1);
    QPrinter printer;
