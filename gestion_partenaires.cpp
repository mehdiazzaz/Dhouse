...
#include "ui_gestion_partenaires.h"
...
gestion_partenaires::gestion_partenaires(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::gestion_partenaires)
{
    ui->setupUi(this);
}

gestion_partenaires::~gestion_partenaires()
{
    delete ui;
}

void gestion_partenaires::on_pb_ajouterPart_2_clicked()
{
...
void gestion_partenaires::on_ch_nom_2_clicked()
{
...
void gestion_partenaires::on_pushButton_Statistique_clicked()
{
    statistique s;
    s.show();
}

void gestion_partenaires::on_trier_cin_2_clicked()
{
     ui->tabPart_2->setModel(tmppartenaire.trier_CIN());
}

void gestion_partenaires::on_pb_supprimerPart_2_clicked()
{
...
void gestion_partenaires::on_pb_modifierPart_2_clicked()
{
...
void gestion_partenaires::on_pb_ajouterPub_2_clicked()
{
...
void gestion_partenaires::on_trier_id_2_clicked()
{
 ui->tabPublicite_2->setModel(tmppublicite.trierIdPub());
}

void gestion_partenaires::on_pb_supprimerPub_2_clicked()
{
...
void gestion_partenaires::on_pb_modifierPub_2_clicked()
{
